/* 
아래의 코드 단위는 사물 자체가 아니라, 장차 사물을 대량으로 생산할 수 있는 틀이다!
...
class Arrow{
    ...
    // 대명사를 붙여야 하며, this라는 정해진 변수를 쓴다.
    // 소유권 '주체'의 소유

    // ES 2015년에 발표된 js에 의해서, 클래스가 소유한 변수는 constructor()하는 생성자
    // 함수에 넣어둬야 한다.
    constructor(x,y){
        this.arrow;
        this.stepX = 10;
        ...
        this.arrow.style.fontSize = 30 + "px";
