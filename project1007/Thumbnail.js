...
class Thumbnail{
    constructor(container, width, height, bd, src, x){
        ...
        this.div.style.border = this.bd + "px solid rgb(75, 74, 74)";
        ...
        this.img.addEventListener("click", function(){
            ...
            // 객체의 인스턴스를 가리키게 되는 것이 ㄹ아니라, 익명함수의 {}영역을 가리키게 된다.
            // 현재 객체가 배열의 몇 번째인지 알아맞추기
            var index = thumbArray.indexOf(me);
            console.log("저는 thumbArray의 "+index+"번째에 있으니, marvel 배열의 "+index+"번째를 이용할 겁니다.");
            getDetail(index);
